<%@ Page Title="" Language="C#" MasterPageFile="~/VGC.master" AutoEventWireup="true" CodeFile="BlackoutDates.aspx.cs" Inherits="BlackoutDates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="text-primary">BlackOut Dates</h4>
                </div>
        ...
        <div class="panel-body">
            <div class="col-md-12">
                <table id="tblBlackoutDatesList" class="table table-bordered table-hover table-condensed table-responsive">
                    <thead>
                        <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">BlackOut Dates Form in
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-4"  for="txtFirstName">Name:</label>
                                    <div class="col-sm-8">
                                 ...
                                 <div class="form-group" id="StatusShow">
                                    <label class="control-label col-sm-4"  for="chkStatus"><label id="lblStatusText" ></label>Active:</label>
                                    <div class="col-sm-8">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ctlscript" Runat="Server">
    ...
    <script src="Pages/BlackDates.js"></script>
        ...
        {%>alert("You don't have rights to perform this action."); return false;<%}%>
                ...
                function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "BlackoutDates.aspx/DeleteBDatesbyId",
                        dataType: "json",
            ...
            function BindTable() {
                ...
                $("#tblBlackoutDatesList").dataTable().fnDestroy();
                $.ajax({
                    type: "POST",
                    url: "BlackoutDates.aspx/GetBlackOutdates",
                    dataType: "json",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    async: true,
                    ...
                    success: function (msg) {
                        $('#tblBlackoutDatesList').dataTable({
