...
public partial class GCSReport : System.Web.UI.Page
{
    ...
    #region Web Methods
    [WebMethod]
    public static string GetGCSReportData(Reports.GCSParams GCSParams)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = DReportDataTable.GetGCSReportData(GCSParams);
