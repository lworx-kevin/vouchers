<%@ Page Title="" Language="C#" MasterPageFile="~/VGC.master" AutoEventWireup="true" CodeFile="GiftCertificates.aspx.cs" Inherits="GiftCertificates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="text-primary">Gift Certificate</h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Certificate Master Form in
...
<%--                                <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-4"  for="txtAmount">Certificate Amount:</label>
                                    <div class="col-sm-8">
    ...
    <script src="Pages/GC.js"></script>
        ...
        {%>alert("You don't have rights to perform this action."); return false;<%}%>
                ...
                function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "GiftCertificates.aspx/DeleteCerificatebyId",
                        dataType: "json",
            ...
            function BindTable() {
                ...
                $.ajax({
                    type: "POST",
                    url: "GiftCertificates.aspx/GetCertificates",
                    dataType: "json",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    async: true,
