...
public partial class GCRReport : System.Web.UI.Page
{
    ...
    #region Web Methods
    [WebMethod]
    public static string GetGCRReportData(Reports.GCSParams GCRParams)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = DReportDataTable.GetGCRReportData(GCRParams);
