...
public partial class VIReport : System.Web.UI.Page
{
    ...
    #region Web Methods
    [WebMethod]
    public static string GetVIReportData(Reports.VIParams VIParams)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = DReportDataTable.GetVIReportData(VIParams);
