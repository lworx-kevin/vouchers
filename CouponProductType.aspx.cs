...
public partial class CouponProductType : System.Web.UI.Page
{
    ...
    public static string GetCouponProductTypeData()
    {
        ...
        var data = Ddatatable.GetCouponProductTypeData();
    ...
    [WebMethod]
    public static string InsertCouponProductTypeData(Coupons.CouponProductType CouponProductType)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = Ddatatable.InsertCouponProductTypeData(CouponProductType);
        HttpContext context = HttpContext.Current;
        context.Response.Filter = new GZipStream(context.Response.Filter, CompressionMode.Compress);
        HttpContext.Current.Response.AppendHeader("Content-Encoding", "gzip");
        HttpContext.Current.Response.ContentType = "application/json charset=utf-8";
    ...
    public static string GetCouponProductTypeDataById(Int32 ProductId)
    {
        ...
        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = Ddatatable.GetCouponProductTypeDataById(ProductId);
        HttpContext context = HttpContext.Current;
        context.Response.Filter = new GZipStream(context.Response.Filter, CompressionMode.Compress);
        HttpContext.Current.Response.AppendHeader("Content-Encoding", "gzip");
        HttpContext.Current.Response.ContentType = "application/json charset=utf-8";
    ...
    public static string DeleteCouponProductTypeDataById(Int32 ProductId)
    {
        ...
        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = Ddatatable.DeleteCouponProductTypeDataById(ProductId);
        HttpContext context = HttpContext.Current;
        context.Response.Filter = new GZipStream(context.Response.Filter, CompressionMode.Compress);
        HttpContext.Current.Response.AppendHeader("Content-Encoding", "gzip");
        HttpContext.Current.Response.ContentType = "application/json charset=utf-8";
