...
public partial class VOReport : System.Web.UI.Page
{
    ...
    #region Web Methods
    [WebMethod]
    public static string GetVOReportData(Reports.VOParams VOParams)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = DReportDataTable.GetVOReportData(VOParams);
