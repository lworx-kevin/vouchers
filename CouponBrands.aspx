<%@ Page Title="" Language="C#" MasterPageFile="~/VGC.master" AutoEventWireup="true" CodeFile="CouponBrands.aspx.cs" Inherits="CouponBrands" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="text-primary">Coupon Brand</h4>
                </div>
        ...
        <div class="panel-body">
            <div class="col-md-12">
                <table id="tblCouponBrandList" class="table table-bordered table-hover table-condensed table-responsive">
                    <thead>
                        <tr>
                         <th></th>
                            <th class="col-md-3">Brand Name</th>
                            <th class="col-md-2">Brand Img</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Coupon Brand Master Form in
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4"  for="txtBrandName">Brand Name:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="txtBrandName"  name="txtBrandName" placeholder="Brand Name" required>
                                    </div>
                                </div>
                                  <div class="form-group">
                                    <label class="control-label col-sm-4" for="ImgBrand">Brand Image:</label>

                                    <div id="dvImgBrowse" class="col-sm-4">
                                       <input type="file" id="ImgBrand" />

                                    </div>
                                      <div class="col-sm-4">
                                          <img id="imgdisplay" src=""  style="width: auto; max-width: 150px; height: auto;" />
                                    </div>
                                </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ctlscript" Runat="Server">
     ...
     <script src="Pages/Brand.js"></script>
    ...
    {%>alert("You don't have rights to perform this action."); return false;<%}%>
                ...
                function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CouponBrands.aspx/DeleteCouponBrandById",
                        dataType: "json",
            ...
            function BindTable() {
                ...
                $("#tblCouponBrandList").dataTable().fnDestroy();
                $.ajax({
                    type: "POST",
                    url: "CouponBrands.aspx/GetCouponBrands",
                    dataType: "json",
                    data: "{}",
                    contentType: "application/json; charset=utf-8",
                    async: true,
                            ...
                            columns: [
                                  ...
                                  { data: "BrandName" },
                                  {
                                      ...
                                      "render": function (data, type, row) {
                                          return '<image src="http://portal.sunwingvouchers.com/media/' + data + '" style=" width:auto; max-width:150px;height:auto;" />';
                                      }
