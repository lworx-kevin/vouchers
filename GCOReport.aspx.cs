...
public partial class GCOReport : System.Web.UI.Page
{
    ...
    #region Web Methods
    [WebMethod]
    public static string GetGCOReportData(Reports.GCOParams GCOParams)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = DReportDataTable.GetGCORReportData(GCOParams);
