...
public partial class VRReport : System.Web.UI.Page
{
    ...
    #region Web Methods
    [WebMethod]
    public static string GetVRReportData(Reports.VRParams VRParams)
    {

        //send id=0 for all data
        //var data = BAL.Select_Brands(0);
        var data = DReportDataTable.GetVRReportData(VRParams);
